...
inline void CPU::execute( void ) {
    ...
    switch ( currentOpcode.getOutput() ) {
        ...
        case ( Opcode::jumpToReg ):
            debug( "Jump to Register execute" );
        ...
        case ( Opcode::branchIfPositive ):
            debug( "Branch if positive execute" );
